...
\begin{abstract}
We introduce Sterling, a web-based visualization tool that provides interactive views of relational models and enables users to create custom visualizations using modern JavaScript libraries.
