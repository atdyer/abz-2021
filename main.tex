...
\node[draw, fit=(scriptview.south west)(scriptview.south east), anchor=north, below=1.75em of scriptview.south, minimum height=1.5em, inner sep=0, outer sep=0, label=center:\scriptsize React] (react) {};
