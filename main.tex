...
\begin{abstract}
We introduce Sterling, a web-based visualization tool that provides interactive views of relational models and enables users to create custom visualizations using modern JavaScript libraries such as D3 and Cytoscape.
Users enjoy the same immediate visual feedback provided by tools like Alloy.
We outline its design goals and architecture, and describe custom visualizations developed with Sterling that enable verification studies of production scientific software.
...
Consistent with design goals 1 and 2, Sterling is a React web application\footnote{A Sterling demo with examples can be found at \href{https://alloy-js.github.io/demo}{https://sterling-js.github.io/demo}}, packaged with a custom build of Alloy, that is launched automatically in the user's default browser by Alloy when an instance is generated. 
