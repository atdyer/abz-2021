...
In a subsequent study~\cite{dyer2019}, our group uses Alloy to perform bounded verification of sparse matrix formats, which use array indirection and other structure to avoid storing zeroes.
