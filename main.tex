...
\begin{abstract}
We introduce Sterling, a web-based visualization tool that enables users to create custom visualizations using modern JavaScript libraries without sacrificing the immediate visual feedback provided by tools like Alloy.
...
Consistent with design goals 1 and 2, Sterling is a React web application\footnote{A Sterling demo with examples can be found at \href{https://alloy-js.github.io/demo}{https://alloy-js.github.io/demo}}, packaged with a custom build of Alloy, that is launched automatically in the user's default browser by Alloy when an instance is generated. 
